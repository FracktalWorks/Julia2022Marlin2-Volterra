...
#define HOTEND_OFFSET_Z { 0.0, -4.00 }  // (mm) relative Z-offset for each nozzle
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100,  100, 200, 140 } //{ 100,  100, 503.937, 140 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION       { 1500, 1500, 15, 10000 }
...
#define DELAY_BEFORE_PROBING 600//200  // (ms) To prevent vibrations from triggering piezo sensors
...
#define INVERT_Z_DIR    false//  for Southern
...
#define MANUAL_X_HOME_POS -40//-10
