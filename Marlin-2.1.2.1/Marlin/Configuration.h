...
#define STRING_CONFIG_H_AUTHOR "(Fracktal Works, default config)" // Who made the changes.    //FW
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_GEN_L_V21  //BOARD_RAMPS_14_EFB    //FW
#endif
 ...
 */
#define X_DRIVER_TYPE  TMC2209    //FW
#define Y_DRIVER_TYPE  TMC2209    //FW
#define Z_DRIVER_TYPE  TMC2209    //FW
...
#define E0_DRIVER_TYPE TMC2209    //FW
#define E1_DRIVER_TYPE TMC2209    //FW
...
#define HEATER_0_MAXTEMP 275        //FW
#define HEATER_1_MAXTEMP 275        //FW
...
//#define THERMAL_PROTECTION_CHAMBER // Enable thermal protection for the heated chamber  //FW
//#define THERMAL_PROTECTION_COOLER  // Enable thermal protection for the laser cooling   //FW
...
//#define USE_YMIN_PLUG     //FW  
//#define USE_ZMIN_PLUG     //FW
...
#define USE_YMAX_PLUG       //FW
#define USE_ZMAX_PLUG       //FW
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 503.937, 140 }      //FW
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 20, 45 }       //FW
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 10000 }    //FW
 ...
 */
#define S_CURVE_ACCELERATION    //FW
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0.2 }    //FW

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 25     //FW

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (2*60)    //FW

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 15)      //FW
...
#define Z_PROBE_LOW_POINT          -5 // Farthest distance below the trigger-point to go before stopping    //FW
...
#define DELAY_BEFORE_PROBING 600  // (ms) To prevent vibrations from triggering piezo sensors   //FW
...
// :[-1,1]
#define X_HOME_DIR -1
#define Y_HOME_DIR 1    //FW
#define Z_HOME_DIR 1    //FW
//#define I_HOME_DIR -1
//#define J_HOME_DIR -1
//#define K_HOME_DIR -1
//#define U_HOME_DIR -1
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  //#define ENABLE_LEVELING_FADE_HEIGHT   //FW
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID     //FW
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (20*60) }    //FW  
 ...
 */
#define NUM_SERVOS 1 // Note: Servo index starts with 0 for M280-M282 commands    //FW
