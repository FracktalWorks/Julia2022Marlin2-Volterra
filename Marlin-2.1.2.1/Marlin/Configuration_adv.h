 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 500        // Seconds     //FW
  #define THERMAL_PROTECTION_HYSTERESIS 40     // Degrees Celsius     //FW
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  10000               // Seconds   //FW
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        40 // Seconds    //FW
  #define THERMAL_PROTECTION_BED_HYSTERESIS     15 // Degrees Celsius   //FW

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                80 // Seconds    //FW
...
#define HOME_Y_BEFORE_X                     // If G28 contains XY home Y before X   //FW
//#define HOME_Z_FIRST                        // Home Z first. Requires a Z-MIN endstop (not a probe).
#define CODEPENDENT_XY_HOMING               // If X/Y can't home without homing Y/X first   //FW
...
#define BABYSTEPPING    //FW
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  25      // (steps or mm) Steps or millimeter distance for each Z babystep   //FW
  #define BABYSTEP_MULTIPLICATOR_XY 1       // (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.    //FW
  #if ENABLED(DOUBLECLICK_FOR_Z_BABYSTEPPING)
    #define DOUBLECLICK_MAX_INTERVAL 1250   // Maximum interval between clicks, in milliseconds.
                                            // Note: Extra time may be added to mitigate controller latency.
    #define MOVE_Z_WHEN_IDLE              // Jump to the move Z menu on doubleclick when printer is idle.   //FW
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping    //FW
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       1200        // (mA) RMS current. Multiply by 1.414 for peak current.    //FW
   ...
   */
  #if HAS_STEALTHCHOP
    // #define STEALTHCHOP_XY //FW
    // #define STEALTHCHOP_Z  //FW
    // #define STEALTHCHOP_I  //FW
    // #define STEALTHCHOP_J  //FW
    // #define STEALTHCHOP_K  //FW
    // #define STEALTHCHOP_U  //FW
    // #define STEALTHCHOP_V  //FW
    // #define STEALTHCHOP_W  //FW
    // #define STEALTHCHOP_E  //FW
  #endif
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)  //FW
